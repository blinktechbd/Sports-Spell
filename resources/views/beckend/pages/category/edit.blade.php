                                    ...
                                    <div class="col-12">
                                        <div class="form-group" data-toggle="tooltip" data-placement="top"
                                            ...
                                            <select name="type" id="type"
                                                ...
                                                <option value="default" @if($category->type == 'default') selected @endif>Default Category</option>
                                                <option value="special" @if($category->type == 'special') selected @endif>Special Category</option>
                                            </select>
                                            @error('type')
