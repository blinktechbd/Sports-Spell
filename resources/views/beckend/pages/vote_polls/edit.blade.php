...
@section('admin-content')
    @push('breadcumb')
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-danger">Vote Poll Edit</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="row g-4">
                <div class="col-lg-6">
                    <form action="{{ route('vote-polls.update', $votePoll->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card card-danger card-outline mb-4">
                            <div class="card-header">
                                <div class="card-title text-danger">Vote Poll Edit</div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <div class="form-group">
                                            <input type="text" name="title"
                                                ...
                                                title="Vote Poll Title" value="{{ $votePoll->title }}"/>
                                            @error('title')
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-group">
                                            <select name="status" class="form-control form-control-danger">
                                                <option value="active" @if($votePoll->status == 'active') selected @endif>Active</option>
                                                <option value="inactive" @if($votePoll->status == 'inactive') selected @endif>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <p class="text-center text-danger"> ----------------- VOTE OPTIONS [Multiple Add &
                                            ...
                                            @php
                                                $options = old('option') ?? $votePoll->votePollOption->pluck('option_name')->toArray();
                                            @endphp
