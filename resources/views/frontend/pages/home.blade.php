                        ...
                        <div class="row mt-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">ক্রিকেট</a></h5>
                                    </div>
                                </div>
                                ...
                                <a href="{{ route('category-wise-content-details', ['cricket', 'bangladesh', 'ভুটানের বিপক্ষে ঘরের মাঠে অভিষেকের অপেক্ষায় হামজা ভুটানের বিপক্ষে ঘরের মাঠে অভিষেকের অপেক্ষায় হামজা']) }}"
                                    ...
                                    <div class="card border-0 shadow-sm special-left-content">
                                        <img class="card-img-top"
                                            src="{{ asset('/storage/assets/images/blogs/image-1.jpg') }}" alt="image-1">
                                        <div class="card-body">
                                            <small
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">ফুটবল</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">টেনিস</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">হকি</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                                ...
                                <div class="card border-0 shadow-sm special-left-content">
                                    ...
                                    <div class="card-body">
                                        <small
                                            ...
                                            | Admin</small>
                                        <h5 class="card-title my-2 text-danger">
                                            <b>{{ Str::limit('ভুটানের বিপক্ষে ঘরের মাঠে অভিষেকের অপেক্ষায় হামজা ভুটানের বিপক্ষে ঘরের মাঠে অভিষেকের অপেক্ষায় হামজা', 30) }}</b>
                                        </h5>
                                        <p class="card-text text-muted">
                                            {{ Str::limit(
                                                'মঙ্গলবার বাফুফে ভবনে অনুষ্ঠিত ম্যাচ-পূর্ববর্তী সংবাদ সম্মেলনে কোচ ক্যাবরেরা ও অধিনায়ক জামাল ভুঁইয়া উপস্থিত ছিলেন। কোচ জানান, ইংল্যান্ড থেকে এসে হামজা গতকালই দলের সঙ্গে অনুশীলনে অংশ নিয়েছেন এবং ভুটানের বিপক্ষে ম্যাচে তাকে মাঠে দেখা যাবে বলে আশা করা হচ্ছে। তবে ইতালিপ্রবাসী ফাহমিদুল ইসলামকে মূল দলে রাখা হবে কি না, সে বিষয়ে এখনো সিদ্ধান্ত হয়নি। এছাড়া, কানাডাপ্রবাসী ফুটবলার শমিত সোম আগামীকাল দলের সঙ্গে যোগ দেওয়ার কথা রয়েছে। ভুটানের সঙ্গে প্রীতি ম্যাচ ছাড়াও ১০ জুন এএফসি এশিয়ান কাপ বাছাইপর্বে সিঙ্গাপুরের বিপক্ষে ম্যাচ রয়েছে বাংলাদেশের। এ দুটি ম্যাচ সামনে রেখে ঘোষিত ২৬ সদস্যের প্রাথমিক দলে এই তিন প্রবাসী ফুটবলারকেই রাখা হয়েছে। এর আগে মার্চ মাসে ভারতের বিপক্ষে এশিয়ান কাপ বাছাইপর্বে আন্তর্জাতিক অভিষেক হয় হামজার। এবার ঘরের মাঠে সমর্থকদের সামনে খেলার অপেক্ষায় আছেন তিনি, আর তা নিয়ে ফুটবলপ্রেমীদের মধ্যে তৈরি হয়েছে ব্যাপক উৎসাহ ও উত্তেজনা। তবে টিকিট প্রাপ্তি নিয়ে সমর্থকদের মধ্যে রয়েছে কিছুটা অসন্তোষ ও ক্ষোভ।',
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">কাবাডি</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">বাস্কেটবল</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">ভলিবল</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">বেসবল</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">গল্‌ফ</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">অ্যাথলিট</a></h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
                                    <a href="" class="text-danger fw-bold">বাংলাদেশ</a>
                        ...
                        <div class="row my-4">
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="category-listing d-flex gap-3">
                                    ...
                                    <div class="category">
                                        <h5 class=""><a href=""
                                                class="text-decoration-none text-danger fw-bold">টেবিল টেনিস</a>
                                        </h5>
                                    </div>
                                </div>
                                <div class="tab d-flex gap-3">
